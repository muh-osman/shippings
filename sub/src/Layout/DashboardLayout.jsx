  ...
  const pages = [
    {
      ...
      icon: <PauseCircleFilledIcon sx={{ color: "#757575" }} />,
    },
    {
      id: 2,
      title: "Uploaded",
      path: `${process.env.PUBLIC_URL}/dashboard/uploaded`,
      icon: <CloudDoneIcon sx={{ color: "#757575" }} />,
    },
    {
      id: 3,
      title: "Search",
      path: `${process.env.PUBLIC_URL}/dashboard/search`,
      icon: <SearchIcon sx={{ color: "#757575" }} />,
    },
    {
      id: 4,
      title: "SMS",
      path: `${process.env.PUBLIC_URL}/dashboard/sms`,
